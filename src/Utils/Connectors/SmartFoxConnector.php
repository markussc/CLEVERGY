    ...
    public function getShellyPro3EMResponse($cloudiness = 0)
    {
        ...
        try {
            if ($this->getIp()) {
                ...
                if ($msg === null && ((($power > 50 && $idleType == 'charge' || $power < -50 && $idleType == 'discharge') && new \DateTime($config['timestamp']['date']) < new \DateTime('- 5 minutes')) || new \DateTime($config['timestamp']['date']) < new \DateTime('- 60 minutes'))) {
