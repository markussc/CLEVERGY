    ...
    public function getShellyPro3EMResponse($cloudiness = 0)
    {
        ...
        try {
            if ($this->getIp()) {
                ...
                if ($msg === null && ((($power > 50 && $idleType == 'charge' || $power < -50 && $idleType == 'discharge') && new \DateTime($config['timestamp']['date']) < new \DateTime('- 2 minutes')) || new \DateTime($config['timestamp']['date']) < new \DateTime('- 15 minutes'))) {
