...
RUN echo "15 $BACKUP_HOUR * * * root mysqldump -h db -u clevergy -pclevergy --no-tablespaces clevergy | gzip > /backup/dump_clevergy_$INSTANCENAME.sql.gz" >> /etc/cron.d/oshans
